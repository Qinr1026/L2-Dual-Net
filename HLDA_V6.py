...
class LocalAttentionModule_V6(nn.Module):
    def __init__(self, num_segments):
        super(LocalAttentionModule_V6, self).__init__()
    ...
    def forward(self, x):
        ...
        split_tensors = torch.chunk(l2_norm, self.num_segments, dim=3)
...
class HLDA_DualSpatial_V6(nn.Module):
    def __init__(self, num_segments):
        super(HLDA_DualSpatial_V6, self).__init__()

        self.local_att = LocalAttentionModule_V6(num_segments)
...
class HLDA_V6(nn.Module):
    def __init__(self, in_channels, num_segments):
        super(HLDA_V6, self).__init__()

        self.HLDA_L2Pool = HLDA_L2Pool(in_channels)
        self.HLDA_DualSpatial_V2 = HLDA_DualSpatial_V6(num_segments)
...
# hlda = HLDA_V6(in_channels=64, num_segments=4)
